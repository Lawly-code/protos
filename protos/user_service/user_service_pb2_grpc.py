...
from protos.user_service import user_service_pb2 as protos_dot_user__service_dot_user__service__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in protos/user_service/user_service_pb2_grpc.py depends on'
